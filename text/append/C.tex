...
\begin{itemize}
	...
	\item[--]  \textbf{Fluxo Principal:} 
		...
		\end{comment}
		\subitem 1. O 10.quest  \underline{lista todas as perguntas do TCG, do utilizador}.
...
\begin{itemize}
	...
	\item[--]  \textbf{Fluxo Principal:} 
		...
		\subitem 3. O 10.quest notifica o utilizador que as perguntas TCG foram adicionadas com sucesso.
	\item[--]  \textbf{Fluxo de Excepção:} 
		\subitem 2a. O utilizador carrega um ficheiro com formato inválido.
		\subitem 2a1. O 10.quest notifica o utilizador que o ficheiro carregado é inválido.
...
\begin{itemize}
	...
	\subitem 2. O utilizador introduz o texto da pergunta TCG.

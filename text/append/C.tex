...
\begin{itemize}
	...
	\item[--]  \textbf{Estimulo:} RF15 - Mostrar lista de perguntas TCG do utilizador.
	\item[--]  \textbf{Fluxo Principal:} 
	...
	\subitem 1b. O serviço do TCG (API) está indisponível.
	\subitem 1b1. O 10.quest notifica o utilizador que o serviço do TCG está temporariamente indisponível. 
	\item[--]  \textbf{Observações:} Depois do 10.quest listar todas as perguntas TCG e o utilizador escolher a pergunta TCG que pretende editar, pode efetuar as \underline{operações desejadas} que estão detalhasdas no RF42 - Criar pergunta TCG. É de notar que os campos relativos à criação de uma pergunta TCG irão estar preenchidos com oa valores definidos inicialmente.
\end{itemize}
\newpage
...
\begin{itemize}
	...
	\item[--]  \textbf{Pré-condições:} O utilizador necessita de estar autenticado na plataforma 10.quest e ter pelo menos uma pergunta TCG criada.
	\item[--]  \textbf{Estimulo:} RF45 - Mostrar lista de perguntas TCG.
	\item[--]  \textbf{Fluxo Principal:} 
	...
	\subitem 3b. O serviço do TCG (API) está indisponível.
	\subitem 3b1. O 10.quest notifica o utilizador que o serviço do TCG está temporariamente indisponível. 
	\item[--]  \textbf{Observações:} O utilizador pode selecionar multiplas perguntas TCG para serem eliminadas. 
\end{itemize}
\newpage
...
\begin{itemize}
	...
	\item[--]  \textbf{Descrição:} 
	\item[--]  \textbf{Pré-condições:} O utilizador necessita de estar autenticado na plataforma 10.quest.
	\item[--]  \textbf{Estimulo:} O utilizador deseja efectuar as \underline{operações desejadas}.
	\item[--]  \textbf{Fluxo Principal:} 
...
\begin{itemize}
	...
	\item[--]  \textbf{Ator:} Utilizador.
	\item[--]  \textbf{Prioridade:} \textit{Must Have}.
	\item[--]  \textbf{Descrição:} Dados/estatísticas globais sobre as formações, questionáris e concursos.
	\item[--]  \textbf{Pré-condições:} O utilizador necessita de estar autenticado na plataforma 10.quest.
	\item[--]  \textbf{Estimulo:} RF48 - Relatórios
	\item[--]  \textbf{Fluxo Principal:} 
...
\begin{itemize}
	...
	\item[--]  \textbf{Pré-condições:} O utilizador necessita de estar autenticado na plataforma 10.quest.
	\item[--]  \textbf{Estimulo:} O utilizador deseja atualizar o pacote de funcionalidades.
	\item[--]  \textbf{Fluxo Principal:} 
...
\begin{itemize}
	...
	\item[--]  \textbf{Pré-condições:} O utilizador necessita de estar autenticado na plataforma 10.quest.
	\item[--]  \textbf{Estimulo:} O utilizador deseja aceder ao centro de ajuda da plataforma 10.quest.
	\item[--]  \textbf{Fluxo Principal:} 
	\subitem 1. O utilizador carrega no notão ajuda.
	...
	\subitem 4. O utilizador introduz o texto da mesagem (i. e. corpo da mensagem)
	...
	\item[--]  \textbf{Fluxo de Excepção:} 
	\subitem 5a. O utilizador carrega uma ficheiro com formato inválido.

...
\begin{itemize}
	...
	\item[--]  \textbf{Observações:} Depois de listadas as leads o utilizador pode efetuar as seguintes \underline{operações}:
		\subitem Filtrar por tags de perfil de personalidade. Se duas tags forem introduzidas, apenas serão listados leads que têm pelo menos essas duas leads associadas.
...
\begin{itemize}
	...
	\item[--]  \textbf{Observações:} Depois do utilizador da plataforma aceder à página das definições de conta, pode efetuar as seguintes \underline{operações}:
		...
		\subitem Alterar Morada da empresa.
		\subitem Alterar email associado à conta.
		\subitem Alterar email associado à empresa.

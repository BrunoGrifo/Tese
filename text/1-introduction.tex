...
\begin{itemize}
	\item[--] Criar questionários que, baseado nas respostas do utilizador final, apresente um resultado no fim do questionário. Neste sentido não só terá de ser aplicado ou desenvolvido um algoritmo para calculo do resultado final, descrito no Capítulo \ref{sec:arquitetura}, como também terá de ser pensada uma forma intuitiva de o utilizador do \gls{backoffice} conseguir construir este mesmo questionário, sem que seja necessário quaisquer conhecimentos de programação por parte do mesmo.
